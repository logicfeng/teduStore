...
public class GoodsCategory implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1596335936139239914L;
	private Long id;
	...
	public Date getModified_user() {
		return modified_user;
	}

	public void setModified_user(Date modified_user) {
	...
	public String toString() {
		return "GoodsCategory [id=" + id + ", parentId=" + parentId + ", name=" + name + ", status=" + status
				+ ", sortOrder=" + sortOrder + ", isParent=" + isParent + ", created_time=" + created_time
