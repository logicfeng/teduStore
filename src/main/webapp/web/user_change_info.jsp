...
<div id="container" class="clearfix">
    ...
    <div class="rightsidebar_box rt">
        ...
        <div class="rs_content">
        		<form id="uploadForm" enctype="multipart/from-data" method="post">
            <!--头像-->
            <div class="rs_content_headPortrait">
	                <span class="same">我的头像：</span>
	               	<c:if test="${user.avator==null}">
	                			<img src="../images/personage/touxiang.png" alt="" id="icon" width="50px" height="50px"/>
	               	</c:if>
	               	<c:if test="${user.avator!=null}">
	                			<img src="../${user.avator}" alt="" id="icon" width="50px" height="50px"/>
	               	</c:if>
            ...
            <div class="rs_content_sex">
                <span class="same">性别(${user.gender})：</span>
						 <span>
            ...
            <!--保存按钮-->
            <div class="save" onclick="changeInfo()">
                保存更改
            </div>
            </form>
        </div>
...
function changeInfo(){
	...
	//var phone = $("#phone").val();
	//var email = $("#email").val();
	//var data = "username="+username+"&gender="+gender+"&phone="+phone+"&email="+email;
	//提交ajax请求并处理结果
	...
	$.ajax({
		...
		"success":function(obj){
			if(obj.state==1){
				alert("修改成功！");
				if(obj.date!=null){
					$("#icon").attr("src","../"+obj.date);
				}
			}else{
				alert("修改失败！"+obj.message);
			}
		}
	})
}
