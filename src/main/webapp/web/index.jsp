    ...
    <div class="lf1_bottom">
        <div class="item_cat lf">
            ...
            <div class="item_cat_all">
                <p>电脑整机</p>
                <ul>
                		<c:forEach var="goodsCategory" items="${goodsCategoiesList[0]}">
                    <li><a href="../goods/list.do?categoryId=${goodsCategory.id}">${goodsCategory.name}</a></li>
                    </c:forEach>
                </ul>
                <p>电脑配件</p>
                <ul>
                   <c:forEach var="goodsCategory" items="${goodsCategoiesList[1]}">
                    <li><a href="../goods/list.do?categoryId=${goodsCategory.id}">${goodsCategory.name}</a></li>
                    </c:forEach>
                </ul>
                <p>外设/游戏</p>
                <ul>
                    <c:forEach var="goodsCategory" items="${goodsCategoiesList[2]}">
                    <li><a href="../goods/list.do?categoryId=${goodsCategory.id}">${goodsCategory.name}</a></li>
                    </c:forEach>
                </ul>
            </div>
        ...
        <div class="item_msg lf">
            <img src="${pageContext.request.contextPath}${goods.image}" alt=""/>

            <p class="bottom_ys2">${goods.title}</p>

            <p class="bottom_ys3">￥${goods.price}</p>

            <p class="bottom_ys4 color_2"><a href="product_details.html?id=${goods.id}">查看详情</a></p>
        </div>
        </c:forEach>
    </div>
</div>
