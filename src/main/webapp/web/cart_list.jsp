                ...
                <div class="imfor">
                    ...
                    <div class="pudc">
                        <div class="pudc_information" id="pudcId2">
                            <img src="..${cart.goodsImage }" width="84" height="84" class="lf"/>
                    ...
                    <div class="pices">
                        ...
                        <p class="pices_information"><b>￥</b><span>${cart.goodsPrice }.00</span></p>
                    </div>
                    <div class="num"><span class="reduc">&nbsp;-&nbsp;</span><input type="text" value="${cart.goodsNum }" /><span class="add">&nbsp;+&nbsp;</span></div>
                    <div class="totle">
                        <span>￥</span>
                        <span class="totle_information">${cart.goodsPrice * cart.goodsNum }.00</span>
                    </div>
                    <div class="del">
